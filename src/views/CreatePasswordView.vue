<template>
    <div class="create-password-view">
        <div class="create-password-view-content">
            ...
            <template v-else>
                <AdminPasswordForm
                    buttonText="Créer votre mot de passe"
                    title="Bienvenue sur CAEN STREET BALL Créez votre mot de passe pour accéder à votre compte"
        ...
        <div class="create-password-view-content__right">
